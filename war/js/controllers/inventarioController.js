...
app.controller("inventarioController",[
	...
	'herramientasService',
	'tornillosService',
	'lotesService','almacenService',
	function($scope, inventarioService, $routeParams,$location, $window, herramientasService, tornillosService, lotesService,almacenService){
		...
		$scope.getAlmacen= function(id){
			for(i in $scope.almacen){
				if($scope.almacen[i].id == id){
					return $scope.almacen[i].nombre
				}
			}
